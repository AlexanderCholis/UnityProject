...
public class ManOutsideResidence : MonoBehaviour
{
    public LocalizedString ManResidenceMessage;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            if (dialogueText != null)
            {
                ...
                {
                    string localizedMessage = ManResidenceMessage.GetLocalizedString();

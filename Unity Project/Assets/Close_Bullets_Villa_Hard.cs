...
public class Close_Bullets_Villa_Hard : MonoBehaviour
{
    public LocalizedString BulletsHard;
    //public string npcMessage = "You found the bullets, keep going!";
    public Canvas dialogueCanvas; // Link this in the Unity Editor
    private TextMeshProUGUI dialogueText;

    public GameObject Bullets;

    public static bool bulletsflag = false;
    ...
    IEnumerator HideObjectDelayed(float delay)
    {
        ...
        {
            Debug.LogError("Bullets GameObject is not assigned.");
        }
    }
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            if (dialogueText != null)
            {
                ...
                string localizedMessage = BulletsHard.GetLocalizedString();

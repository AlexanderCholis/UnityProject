...
public class Close_Rock_Playground_Medium : MonoBehaviour
{
    public LocalizedString CloseRockMedium;
    ...
    IEnumerator HideObjectDelayed(float delay)
    {
        ...
        {
            Debug.LogError("BlackRock GameObject is not assigned.");
        }
    }
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            if (dialogueText != null)
            {
                ...
                string localizedMessage = CloseRockMedium.GetLocalizedString();

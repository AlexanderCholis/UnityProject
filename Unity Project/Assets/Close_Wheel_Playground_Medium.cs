...
public class Close_Wheel_Playground_Medium : MonoBehaviour
{
    public LocalizedString CloseWheelMedium;
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            if (dialogueText != null)
            {
                ...
                string localizedMessage = CloseWheelMedium.GetLocalizedString();

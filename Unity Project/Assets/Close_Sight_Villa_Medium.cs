...
public class Close_Sight_Villa_Medium : MonoBehaviour
{
    public LocalizedString SightMedium;
    //public string npcMessage = "You found the sight, keep going!";
    public Canvas dialogueCanvas; // Link this in the Unity Editor
    private TextMeshProUGUI dialogueText;

    public GameObject Sight;

    public static bool sightflag = false;
    ...
    IEnumerator HideObjectDelayed(float delay)
    {
        ...
        {
            Debug.LogError("Sight GameObject is not assigned.");
        }
    }
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            if (dialogueText != null)
            {
                ...
                string localizedMessage = SightMedium.GetLocalizedString();
    ...
    void Update()
    {
        if (Close_Gun_Villa.gunflag && Close_KitchenKnife_Villa_Medium.rustyknifeflag
            ...
            && sightflag && Close_CombatKnife_Villa_Medium.combatknifeflag

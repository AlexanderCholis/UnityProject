...
public class HiddenObjectsCheckPlaygroundEasy : MonoBehaviour
{
    ...
    */
    ...
    public LocalizedString AllPEasy;
    ...
    void Update()
    {
        if (selectedGameMode == "EASY" && !messageShown)
        {
    ...
    IEnumerator ShowDialogueAfterDelay(float delay)
    {
        ...
        string localizedMessage = AllPEasy.GetLocalizedString();
